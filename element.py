...
class Element(object):
    """An OOP representation of an Element"""
    def __init__(self, an, symbol, name, mass_num):
        self.symbol = symbol
        self.name = name
        self.atomic_number = an

        if type(mass_num) == str and mass_num.startswith("["):
            mass_num = mass_num.strip("[]")

        self.mass_number = float(mass_num)
